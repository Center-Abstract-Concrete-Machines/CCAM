...
### note: this workshops is free and open to the public.

# Overview

In this workshop, we will solder the Alien Screamer, a small, classic desktop synth developed by Ray Wilson in the 1990s. Along the way, we will touch on various topics: “open-source” hardware, DIY synth economy and ethics, PCB layout design and fabrication, soldering technique, and analog synthesis concepts.
