...
Weaving together personal narratives, myths, and speculative histories, this expanded cinema performance presents strategies for reaching unreachable places using six projectors (three digital, one 16mm, one slide, and one overhead).
...
### Liyan Zhao and Liam O'Brien // The Question of Grief (2024)
