...
---
import earth1 from './images/ccam_earth1.jpg'
import earth2 from './images/ccam_earth2.jpg'
...
<Image src={earth1} alt="CCAM EARTH" widths={[400, 600, 1200, earth2.width]} />
...
<a href="/assets/pdf/2024-05-10-CCAM-EARTH-ZINE.pdf">
    <Image src={frm2} alt="CCAM EARTH ZINE" widths={[400, 600, 1200, earth2.width]} class="w-3/4 mx-auto p-1 border border-dashed border-borderColor/50" />
</a>
