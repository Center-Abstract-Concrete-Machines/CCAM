...
![overhead shot of Rasperry Pi with custom hat prototype. No knobs fitted, with hdmi and power plugged in](./images/videosynth/one.jpg)

![Side shot of RPi with hat. Blue knobs added atop, with two purple 3.5mm cables going into CV in jacks and a green one coming out the CV out jack](./images/videosynth/two.jpg)

![Same config as above but different angle](./images/videosynth/three.jpg)

![Overhead shot of Rpi with hat, with plug config described above. This time we see it runs to an EARTH synthesizer, a CCAM prototype. This sends audio out to a little amp board with DIY speakers. A small project is seen on the table top, as well as soldering supplies.](./images/videosynth/four.jpg)
